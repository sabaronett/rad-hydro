...
# Athena++ modules
import sys
sys.path.insert(0, '/home/stanley/github/sabaronett/athena/vis/python')
import athena_read
...
def main(**kwargs):
    ...
    plt.colorbar(im, label=f'{cb_label}')
    if kwargs['output_file'] == 'show':
        plt.show()
    else:
